        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employee_Subcontractor_SubcontractorID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnOrRent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Equipment_Employee_EmployeesEmployeeID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Project_Subcontractor_SubcontractorID",
                        column: x => x.SubcontractorID,
                        principalTable: "Subcontractor",
                        principalColumn: "SubcontractorID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employee_SubcontractorID",
                table: "Employee",
                column: "SubcontractorID");

            migrationBuilder.CreateIndex(
                name: "IX_Equipment_EmployeesEmployeeID",
                table: "Equipment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Project_SubcontractorID",
                table: "Project",
                column: "SubcontractorID");
        }
