...
namespace ConstructionCompanyDB.Controllers
{
    public class EquipmentsController : Controller
    {
        ...
        public EquipmentsController(ConstructionCompanyDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Equipment != null ? 
                          ...
                          Problem("Entity set 'ConstructionCompanyDBContext.Equipment'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EquipmentID,EquipmentName,Manufacturer,OwnOrRent,EmployeeID")] Equipment equipment)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ConstructionCompanyDBContext.Equipment'  is null.");
            }
            var equipment = await _context.Equipment.FindAsync(id);
            if (equipment != null)
            {
